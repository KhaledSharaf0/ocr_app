...
class IconBroken {
  ...
  static const IconData dot = IconData(0x25B8, fontFamily: _fontFamily);

  static const IconData interviewers = IconData(60420, fontFamily: 'MaterialIcons');static const IconData types = IconData(57487, fontFamily: 'MaterialIcons');
  static const IconData categories = IconData(62826, fontFamily: 'MaterialIcons');
}
